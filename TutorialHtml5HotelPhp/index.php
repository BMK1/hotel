...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="media/ta.css" />
            ...
            <div id="header">
                <div class="bg-help">
                    <div class="inBox">
                        ...
                        <p id="claim"><a href="http://localhost/php_test/login1.php">logout</a> 
                        <hr class="hidden" />
                    </div>
                </div>
            </div>
...
$query = "select id,name,room_type,email,ti,str from inf;"; 
$result = mysqli_query($mysql,$query); 


 echo '<table border="1" style="width:50%;margin-left:100px"><tr><td >id</td> <td >name</td><td >room type</td><td >Email</td><td>day</td><td>time</td><td></td><td></td>';
while($row=mysqli_fetch_array($result))
{
echo "<tr><td class='lalign'>".$row['id']."</td>";
echo "<td >".$row['name']."</td>";
...
echo "<td class='lalign'><a href='de.php?id=".$row['id']."'>delete</a></td><tr>";
